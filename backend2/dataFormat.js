...
import { isObject, isNumber, tag } from '@turf/turf'
...
const shopLayerMap = {
  ...
  greengrocer: layer,
  greeting_cards: layer,
  greetings_cards: layer,
  grocer: layer,
  grocery: layer,
  haberdashery: layer,
 ...
 * @param {Object} tags OSM attributes for the feature
 * @returns {string} name of the layer(s) to use
 */
